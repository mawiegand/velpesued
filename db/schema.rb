...
ActiveRecord::Schema.define(version: 20190207213554) do
  ...
  create_table "refinery_divisions", force: :cascade do |t|
    t.string "name"
    t.text "description"
    t.integer "position"
    t.datetime "created_at", null: false
    ...
    t.index ["slug"], name: "index_refinery_divisions_on_slug", unique: true
  end

  create_table "refinery_divisions_groups", force: :cascade do |t|
    t.string "name"
    t.integer "photo_id"
    t.text "description"
    t.integer "position"
    ...
    t.string "slug", null: false
    t.index ["slug"], name: "index_refinery_divisions_groups_on_slug"
  end

  create_table "refinery_divisions_positions", force: :cascade do |t|
    t.string "title"
    t.integer "position"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    ...
    t.bigint "manageable_id"
    t.index ["manageable_type", "manageable_id"], name: "index_refinery_divisions_positions_on_manageable_type_and_id"
  end

  create_table "refinery_facilities", force: :cascade do |t|
    t.string "name"
    t.integer "photo_id"
    t.string "address"
    t.string "maps_link"
