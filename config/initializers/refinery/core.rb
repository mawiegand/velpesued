...
Refinery::Core.configure do |config|
  ...
  # Site name
  config.site_name = "SC VelpeSüd 1952 e. V."
  ...
  # config.dragonfly_secret = "58590d252639da50cf1229c1ab0652562e68da448679ced8"
  ...
  config.plugin_priority = %w(divisions groups contacts positions facilities sponsors)
end
